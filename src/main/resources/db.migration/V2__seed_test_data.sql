...
-- Store 데이터 추가
INSERT INTO store (id, region_id, name, address, score, closed_day, open_time, close_time, version,
                   created_at, updated_at)
VALUES (1, 1, 'Store 1', '서울시 서대문구 이화여대길 52', 4.5, 'SUNDAY', '08:00:00', '23:59:00', 0, NOW(),
        NOW()),
...
-- Member 데이터 추가
INSERT INTO member (id, name, nickname, social_id, social_type, phone_number, phone_verified,
                    gender, address, email, point, status, version, created_at, updated_at)
VALUES (1, '테스트 회원', '테스터', 'social123', 'KAKAO', '010-1234-5678', TRUE, 'MALE', '서울 강남구',
        'test@example.com', 100, 'ACTIVE', 0, NOW(), NOW());

-- Mission 데이터 추가
INSERT INTO mission (id, store_id, mission_spec, min_spend_money, reward_points, address, deadline,
...
-- Review 데이터 추가
INSERT INTO review (id, member_id, store_id, context, rating, status, version, created_at,
                    updated_at)
