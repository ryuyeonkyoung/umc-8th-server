...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = 1665197628L;
    ...
    public final org.umc.spring.domain.QMember member;

    public final org.umc.spring.domain.QMission mission;

    public final EnumPath<org.umc.spring.domain.enums.MissionStatus> status = createEnum("status", org.umc.spring.domain.enums.MissionStatus.class);
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new org.umc.spring.domain.QMember(forProperty("member")) : null;
        this.mission = inits.isInitialized("mission") ? new org.umc.spring.domain.QMission(forProperty("mission"), inits.get("mission")) : null;
    }
