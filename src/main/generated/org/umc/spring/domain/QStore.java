...
public class QStore extends EntityPathBase<Store> {
    ...
    private static final long serialVersionUID = 1773187755L;
    ...
    public final EnumPath<java.time.DayOfWeek> closedDay = createEnum("closedDay", java.time.DayOfWeek.class);
