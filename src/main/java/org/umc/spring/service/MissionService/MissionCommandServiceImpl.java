...
public class MissionCommandServiceImpl implements MissionCommandService {
  ...
  public MemberMission challengeMission(Long missionId, Long memberId) {
    ...
    // 이미 도전 중인 미션인지 확인
    boolean alreadyChallenged = memberMissionRepository.existsByMissionIdAndMemberId(missionId,
        memberId);
  ...
  public MemberMission completeMission(Long missionId, Long memberId) {
    ...
    MemberMission memberMission = memberMissionRepository.findByMissionIdAndMemberId(missionId,
            memberId)
