package org.umc.spring.config.security.jwt;
...
import org.umc.spring.config.properties.Constants;
import org.umc.spring.config.properties.JwtProperties;
...
public class JwtTokenProvider {
  ...
  public String generateToken(Authentication authentication) {
    ...
    return Jwts.builder()
        ...
        .setExpiration(
            new Date(System.currentTimeMillis() + jwtProperties.getExpiration().getAccess()))
